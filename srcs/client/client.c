...
/*   Updated: 2023/11/17 15:42:14 by sakitaha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
 * In client.c, g_signal_pid_state is used under the constraint of having
 * only one global variable per program.
 * It performs two key functions:
 * 1. Stores the server PID for signal sender verification.
 * 2. Holds the state of the received acknowledgment signal.
 */
